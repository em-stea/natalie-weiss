...
$email_to = "hola@natalie-weiss.de.com";
$contenido = "$nombre ha enviado un mensaje desde la web de natalie weiss<br /> Nombre: $nombre<br />Email: $email<br /> Mensaje: $mensaje";
$asunto = "Consulta desde la Web natalie.weiss";
